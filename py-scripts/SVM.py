...
vocabulary = pickle.load(open("py-scripts/model-dependencies/support-vector-machine/feature.pkl", 'rb'))
...
with open("py-scripts/model-dependencies/support-vector-machine/Pickle_SVC_Model.pkl", 'rb') as file:
